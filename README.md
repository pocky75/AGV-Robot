...
![C](https://img.shields.io/badge/C%2B%2B-Arduino-blue.svg)
...
- ⚖️ **6륜 구조 최적화**: 대회 규격 로봇에 앞뒤 4개의 보조 바퀴를 추가하여 **총 6 구조**로 개조, 무게 중심 안정화 및 라인 추적 정밀도 향상
- 🤝 **2대 로봇 협업**: 2대의 로봇이 동시에 작동하여 물류 이송 효율 극대화
- ⚙️ **VSCode + PlatformIO 개발 환경**: Arduino 기반 펌웨어를 VSCode에서 효율적으로 개발 및 디버깅
